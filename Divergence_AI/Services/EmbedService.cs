...
// New code 
		// Just to get to the dataset			
					...
					var datasets = await client.Datasets.GetDatasetByIdInGroupAsync(WorkspaceId, report.DatasetId);
					string datasetID = datasets.Id;
					
					//var datasetId = '9c10602a-9dc7-4b2d-8d9f-190cf2e354a8';		
                             
////////////////////////////					

 // ### Actual Code  // Generate Embed Token.
					...
					var tokenResponse = await client.Datasets.GenerateTokenInGroupAsync(WorkspaceId, datasets.Id, generateTokenRequestParameters);
